...
export default function CharactersGrid() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
      <CharacterList listKey={CharacterListEnum.FIRST} selectedCharacter={character1} onCharacterSelect={selectCharacter1} />
      <CharacterList listKey={CharacterListEnum.SECOND} selectedCharacter={character2} onCharacterSelect={selectCharacter2} />
    </div>
  );
}
