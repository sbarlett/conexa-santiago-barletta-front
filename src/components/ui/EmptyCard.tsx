export default function EmptyCard({ loading, text }: { loading?: boolean; text?: string }) {
  return (
    <div className="w-full flex flex-col h-[450px] mt-4">
      <div className="w-full h-full">
        <div className="flex justify-center items-center h-full border border-gray-700 bg-gray-900 rounded-lg p-4">
